...
Android 1.0.2 (versionCode 39) is packaged alongside Windows/Linux 1.0.5.
...
Android 1.0.2 adds Character LOD distance in Graphics. Modern and the default
use 5x; Original uses 1x. The maintainer confirmed the adjustment in r38.
